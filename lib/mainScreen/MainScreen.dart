...
import 'package:flutter_test_marvel_api/mainScreen/tabAzureLogin/ui/TabAzureLogin.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon:
                Image.asset(CustomIcons.ICON_AZURE, width: 40.0, height: 40.0),
            title: new Text(StringsConstants.MAIN_SCREEN_AZURE),
          ),

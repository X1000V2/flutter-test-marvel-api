            ...
            Positioned(top: 0.0, left: 0.0, right: 0.0, bottom: 0.0,
              ...
              GestureDetector(
                onTap: (){
                  ...
                  if(numberOfClickToJumpToNextScreen == widget.tapsToTrigger){
                      widget.onTapCustom();
                  }
                },
                child: Container(
                height: 250.0 * (1.3 - _factionTime) * (0.9 + 0.2 * numberOfClickToJumpToNextScreen),
                width: 250.0 * (1.3 - _factionTime) * (0.9 + 0.2 * numberOfClickToJumpToNextScreen),
